...
class Trainer:
    def __init__(self, diffusion, unet, vae, criterion, optimizer, data_loader,
                ...
                content_type='unifont', letters_path=''):
        # content_type/letters_path make validation sampling follow a non-Latin
        # charset (e.g. hieroglyphs); defaults keep the original IAM behaviour.
    ...
    def _valid_iter(self, epoch):
        ...
        load_content = ContentData(content_type=self.content_type, letters_path=self.letters_path)
        # forward
