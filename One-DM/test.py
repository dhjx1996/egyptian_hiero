...
def main(opt):
    ...
    load_content = ContentData(content_type=opt.content_type, letters_path=opt.letters)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--generate_type', dest='generate_type', required=True, help='generation setting: iv_s, iv_u, oov_s, oov_u, or hiero')
    parser.add_argument('--content_type', type=str, default='unifont', help="content pickle in data/ (e.g. 'hiero_content' for hieroglyphs)")
    parser.add_argument('--letters', type=str, default='', help='path to a charset file overriding the Latin default (e.g. data/hiero_letters.txt)')
