...
def main(opt):
    ...
    train_dataset = IAMDataset(
        ...
        content_type=opt.content_type, letters_path=opt.letters, text_txt=(opt.train_txt or None))
    ...
    test_dataset = IAMDataset(
         ...
         content_type=opt.content_type, letters_path=opt.letters, text_txt=(opt.test_txt or None))
    ...
    trainer = Trainer(diffusion, unet, vae, criterion, optimizer, train_loader, logs, test_loader, device,
                      content_type=opt.content_type, letters_path=opt.letters)
    trainer.train()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--content_type', type=str, default='unifont', help="content pickle in data/ (e.g. 'hiero_content')")
    parser.add_argument('--letters', type=str, default='', help='charset file overriding the Latin default (e.g. data/hiero_letters.txt)')
    parser.add_argument('--train_txt', type=str, default='', help='training index file overriding data/IAM64_train.txt')
    parser.add_argument('--test_txt', type=str, default='', help='test index file overriding data/IAM64_test.txt')
